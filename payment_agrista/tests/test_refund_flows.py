...
from odoo.addons.payment_agrista.tests.common import AuthorizeCommon
...
class TestRefundFlows(AuthorizeCommon):
    ...
    def test_refunding_voided_tx_cancels_it(self):
        ...
        with patch(
            'odoo.addons.payment_agrista.models.authorize_request.AuthorizeAPI'
    ...
    @mute_logger('odoo.addons.payment_agrista.models.payment_transaction')
    def test_refunding_authorized_tx_voids_it(self):
        ...
        with patch(
            ...
            'odoo.addons.payment_agrista.models.authorize_request.AuthorizeAPI.void'
        ) as void_mock, patch(
    ...
    def test_refunding_captured_tx_refunds_it_and_creates_refund_tx(self):
        ...
        with patch(
            ...
            'odoo.addons.payment_agrista.models.authorize_request.AuthorizeAPI.refund'
