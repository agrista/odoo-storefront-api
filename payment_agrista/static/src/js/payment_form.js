...
/* global Accept */
    ...
    const agristaMixin = {
        ...
        _getInlineFormInputs: function (providerId) {
            if (this.agristaInfo.payment_method_type === "credit_card") {
                return {
                    card: document.getElementById(`o_agrista_card_${providerId}`),
                    month: document.getElementById(`o_agrista_month_${providerId}`),
                    year: document.getElementById(`o_agrista_year_${providerId}`),
                    code: document.getElementById(`o_agrista_code_${providerId}`),
                };
            } else {
                return {
                    accountName: document.getElementById(`o_agrista_account_name_${providerId}`),
                    accountNumber: document.getElementById(
                        `o_agrista_account_number_${providerId}`
                    ),
                    abaNumber: document.getElementById(`o_agrista_aba_number_${providerId}`),
                    accountType: document.getElementById(`o_agrista_account_type_${providerId}`),
                };
            }
        },
        ...
        /**
         * Prepare the inline form of Agrista for direct payment.
         *
        ...
        _prepareInlineForm: function (code, paymentOptionId, flow) {
            ...
            return this._rpc({
                route: '/payment/agrista/get_provider_info',
                params: {
        ...
        /**
         * Dispatch the secure data to Agrista.
         *
         * @override method from payment.payment_form_mixin
         * @private
        ...
        _processPayment: function (code, paymentOptionId, flow) {
            ...
            const secureData = {
                authData: {
                    apiLoginID: this.agristaInfo.login_id,
                    clientKey: this.agristaInfo.client_key,
                },
                ...this._getPaymentDetails(paymentOptionId),
            };

            // Dispatch secure data to Agrista to get a payment nonce in return
        ...
        /**
         * Handle the response from Agrista and initiate the payment.
         *
         * @private
         * @param {number} providerId - The id of the selected provider
        ...
        _responseHandler: function (providerId, response) {
            ...
            return this._rpc({
                ...
                params: this._prepareTransactionRouteParams('agrista', providerId, 'direct'),
            }).then(processingValues => {
                // Initiate the payment
                return this._rpc({
                    route: '/payment/agrista/payment',
                    params: {
    ...
    checkoutForm.include(agristaMixin);
    manageForm.include(agristaMixin);
