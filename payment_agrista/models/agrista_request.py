...
class AgristaAPI:
    """ Agrista Gateway API integration.
    ...
    (http://developer.agrista.com/api/reference); namely:
    ...
    def __init__(self, provider):
        ...
        self.name = provider.agrista_login
        self.transaction_key = provider.agrista_transaction_key
        self.payment_method_type = provider.agrista_payment_method_type
    ...
    def _prepare_tx_data(self, token=None, opaque_data=False):
        ...
        if token:
            ...
            return {
                'profile': {
                    'customerProfileId': token.agrista_profile,
                    'paymentProfile': {
    ...
    # Provider configuration: fetch agrista_client_key & currencies
