...
from odoo.addons.graphql_storefront.schemas.objects import User
...
class Login(graphene.Mutation):
    ...
    def mutate(self, info, email, password, subscribe_newsletter):
        ...
        try:
            ...
            if website and website.storefront_mailing_list_id and subscribe_newsletter:
                MassMailController().subscribe(website.storefront_mailing_list_id.id, email, 'email')
